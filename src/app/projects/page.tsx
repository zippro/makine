...
export default function ProjectsPage() {
    const { projects, createProject, deleteProject, selectProject, currentProject, isLoading } =
        useProject();
                        ...
                        >
                            <div className="flex justify-between items-start">
                                ...
                                <button
                                    ...
                                    className="text-muted-foreground hover:text-red-500 p-2 rounded-lg hover:bg-red-500/10 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
